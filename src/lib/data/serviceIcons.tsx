...
/**
 * Lucide icon map — used on the /services overview page (ServiceCard grid).
 */
export const serviceIconsLucide: Record<string, React.ReactNode> = {
...
/**
 * Inline SVG icon map — used on the homepage service list rows.
 */
export const serviceIconsSVG: Record<string, React.ReactNode> = {
